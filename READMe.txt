...
# Linear Gradient for home page (background):
...
# Horizontal Gradient for home page (favourite shows section):
...
# Diagonal Gradient for home page (footer section)

/* Permalink - use to edit and share this gradient: https://colorzilla.com/gradient-editor/#ddffff+3,ddffff+3,ddffff+6,ddffff+6,ddffff+12,ddffff+12,80abaf+32,80abaf+32,80abaf+40,80abaf+47,ba3723+75,000000+100 */
background: #ddffff; /* Old browsers */
background: -moz-linear-gradient(45deg,  #ddffff 3%, #ddffff 3%, #ddffff 6%, #ddffff 6%, #ddffff 12%, #ddffff 12%, #80abaf 32%, #80abaf 32%, #80abaf 40%, #80abaf 47%, #ba3723 75%, #000000 100%); /* FF3.6-15 */
background: -webkit-linear-gradient(45deg,  #ddffff 3%,#ddffff 3%,#ddffff 6%,#ddffff 6%,#ddffff 12%,#ddffff 12%,#80abaf 32%,#80abaf 32%,#80abaf 40%,#80abaf 47%,#ba3723 75%,#000000 100%); /* Chrome10-25,Safari5.1-6 */
background: linear-gradient(45deg,  #ddffff 3%,#ddffff 3%,#ddffff 6%,#ddffff 6%,#ddffff 12%,#ddffff 12%,#80abaf 32%,#80abaf 32%,#80abaf 40%,#80abaf 47%,#ba3723 75%,#000000 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#ddffff', endColorstr='#000000',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */
